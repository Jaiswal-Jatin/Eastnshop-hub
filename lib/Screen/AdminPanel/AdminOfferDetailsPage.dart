...
fit: BoxFit.cover,),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: widget.isActive ? Color(0xFF00C853) : Colors.orange,
  ...
  void _showFullScreenImage(BuildContext context, String imageUrl, {String title = 'Image'}) {
    Navigator.push(
      context,
      MaterialPageRoute(
...
class FullScreenImageViewer extends StatefulWidget {
  ...
  const FullScreenImageViewer({super.key, required this.imageUrl, this.title = 'Image'});
